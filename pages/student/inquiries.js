...
import { mockInquiriesWithAnalysis } from "modules/shared/shared.mock-data-v2";

export default function StudentInquiriesPage() {
	const router = useRouter();

	// Filter only active inquiries
	const activeInquiries = mockInquiriesWithAnalysis.filter(
		inq => inq.status === "ACTIVE",
	);
